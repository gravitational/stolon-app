...
// PodStatus represents status of Kubernetes Pod
type PodStatus struct {
	// Pod name
	Name string
	// IP address of the host to which the is assigned
	HostIP string
	// IP address allocated to the pod
	PodIP string
	// Status of the pod
	Status string
	// ReadyContainers - number of ready container
	ReadyContainers int
...
// DeterminePodStatus - k8s.io/kubernetes/pkg/kubectl/resource_printer.go
